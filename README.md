...
| 11 | When registering as a new user, the form should validate, and take the user to the 'confirm email' page | When completing the signup form,  | I tried changing the development variable in the github environment to be exclusive to this project |
