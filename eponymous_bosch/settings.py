"""
Django settings for eponymous_bosch project.
...
DEBUG = 'E_BOSCH_DEVELOPMENT' in os.environ
# DEBUG = False
...
ROOT_URLCONF = 'eponymous_bosch.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # below line is required by allauth
...
WSGI_APPLICATION = 'eponymous_bosch.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'eponymous-bosch'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'eponymousbosch@example.com'
else:
